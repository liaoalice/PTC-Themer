...
function TokenList() {
  return (
    ...
    <ul className="list" id="tokens">
      {/* Colors */}
      {/* Background Colors */}
      <span className="list-flex-row background">
      ...
      {/* Text Colors */}
      <span className="list-flex-row text">
        <span className="token-swatch gray-12"></span>
        <span className="list-name type type--pos-xlarge-normal">
          --cds-color-text
        </span>
      ...
      {/* Border Colors */}
      <span className="list-flex-row border">
      ...
      {/* Icon Colors */}
      <span className="list-flex-row icon">
        <span className="token-swatch gray-10"></span>
        <span className="list-name type type--pos-xlarge-normal">
      ...
      {/* Overlay */}
      <span className="list-flex-row overlay">
      ...
      {/* Interaction */}
      <span className="list-flex-row interaction">
        <span className="token-swatch gray-1"></span>
        <span className="list-name type type--pos-xlarge-normal">
      ...
      {/* Chart Colors */}
      <span className="list-flex-row chart">
